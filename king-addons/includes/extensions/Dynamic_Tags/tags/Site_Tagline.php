...
/**
 * The site tagline from Settings → General.
 */
class Site_Tagline extends Text_Tag
{
    public function get_name()
    {
        return 'king-addons-site-tagline';
    }

    public function get_title()
    {
        return esc_html__('Site Tagline', 'king-addons');
    }
    ...
    {
        $this->ka_echo((string) get_bloginfo('description'));
    }
}
