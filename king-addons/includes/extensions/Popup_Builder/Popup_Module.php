...
<li>Open Popup: Custom Trigger - Button Click, CSS Selector (class or ID)</li>
    ...
    {
        return '<a class="king-addons-pro-features-cta-btn" href="https://kingaddons.com/pricing/?ref=kng-module-' . $widget_name . '-upgrade-pro" target="_blank">' . esc_html__('Learn More About Pro', 'king-addons') . '</a>';
    }
