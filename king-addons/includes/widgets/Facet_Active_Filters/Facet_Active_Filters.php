...
class Facet_Active_Filters extends Widget_Base
{
    ...
    {
        return esc_html__('Active Filters', 'king-addons');
    }
    ...
    {
        return ['shop', 'product', 'filter', 'filters', 'ajax', 'woocommerce', 'active', 'chips', 'faceted', 'smart filters'];
    }
    ...
    public function register_controls(): void
    {
        $this->start_controls_section(
            ...
            [
                'label' => KING_ADDONS_ELEMENTOR_ICON . esc_html__('Active Filters', 'king-addons'),
        ...
        Facet_Style_Controls::chips($this);
    }
