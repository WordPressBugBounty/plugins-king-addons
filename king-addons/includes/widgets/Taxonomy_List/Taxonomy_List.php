    ...
    protected function register_controls()
    {
        ...
        if (!king_addons_freemius()->can_use_premium_code__premium_only()) {
            $this->add_control(
                ...
                [
                    'raw' => 'This option is available<br> in the <strong><a href="https://kingaddons.com/pricing/?ref=kng-module-taxonomy-list-settings-upgrade-pro" target="_blank">Pro version</a></strong>',
