    ...
    protected function register_controls()
    {
        ...
        if (!king_addons_freemius()->can_use_premium_code__premium_only()) {
            $this->add_control(
                ...
                [
                    ...
                    'raw' => 'More than 3 Items are available<br> in the <strong><a href="https://kingaddons.com/pricing/?ref=kng-module-image-accordion-settings-upgrade-pro" target="_blank">Pro version</a></strong>',
        ...
        if (!king_addons_freemius()->can_use_premium_code__premium_only()) {
            $repeater->add_control(
                ...
                [
                    'raw' => 'Vertical and Horizontal Align options are available in the <strong><a href="https://kingaddons.com/pricing/?ref=kng-module-image-accordion-settings-upgrade-pro" target="_blank">Pro version</a></strong>',
        ...
        if (!king_addons_freemius()->can_use_premium_code__premium_only()) {
            $this->add_control(
                ...
                [
                    'type' => Controls_Manager::RAW_HTML,
                    'raw' => 'Advanced button animations are available in the <strong><a href="https://kingaddons.com/pricing/?ref=kng-module-image-accordion-settings-upgrade-pro" target="_blank">Pro version</a></strong>',
                    'content_classes' => 'king-addons-pro-notice',
                ]
            );
        }
