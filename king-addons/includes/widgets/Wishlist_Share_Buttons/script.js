/**
 * Wishlist Share Buttons (Pro) widget behavior.
 *
...
(function ($) {
     ...
     * @returns {void}
     */
    const initWishlistShareButtons = ($scope) => {
    ...
    $(window).on("elementor/frontend/init", function () {
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/king-addons-wishlist-share-buttons.default",
            function ($scope) {
                initWishlistShareButtons($scope);
            }
        );
    });
})(jQuery);
