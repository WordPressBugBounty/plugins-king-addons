        ...
        if (!king_addons_freemius()->can_use_premium_code__premium_only()) {
            $this->add_control(
                ...
                [
                    ...
                    'raw' => 'Advanced overlay animations are available in the <strong><a href="https://kingaddons.com/pricing/?ref=kng-module-team-member-settings-upgrade-pro" target="_blank">Pro version</a></strong>',
    ...
    protected function register_controls()
    {
        ...
        if (!king_addons_freemius()->can_use_premium_code__premium_only()) {
            $this->add_control(
                ...
                [
                    'type' => Controls_Manager::RAW_HTML,
                    'raw' => 'Advanced button animations are available in the <strong><a href="https://kingaddons.com/pricing/?ref=kng-module-team-member-settings-upgrade-pro" target="_blank">Pro version</a></strong>',
                    'content_classes' => 'king-addons-pro-notice',
                ]
            );
        }
