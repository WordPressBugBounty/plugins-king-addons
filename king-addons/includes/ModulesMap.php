    ...
    public static function getModulesMapArray(): array
    {
        return [
            'widgets' => [
                ...
                'facet-taxonomy' => [
                    'title' => esc_html__('Taxonomy Filter', 'king-addons'),
                    'description' => esc_html__('Filter products by category, tag, color, size, or any taxonomy — without reloading the page.', 'king-addons'),
                ...
                'facet-price' => [
                    'title' => esc_html__('Price Filter', 'king-addons'),
                    'description' => esc_html__('Let shoppers filter products by price range. Updates the grid without a page reload.', 'king-addons'),
                ...
                'facet-search' => [
                    'title' => esc_html__('Search Filter', 'king-addons'),
                    'description' => esc_html__('Search products and update the linked grid as the shopper types.', 'king-addons'),
                ...
                'facet-reset' => [
                    'title' => esc_html__('Reset Filters', 'king-addons'),
                    'description' => esc_html__('One button to clear every selected shop filter.', 'king-addons'),
                ...
                'facet-active-filters' => [
                    'title' => esc_html__('Active Filters', 'king-addons'),
                    'description' => esc_html__('Show selected filters as chips so shoppers can remove them one by one.', 'king-addons'),
                ...
                'facet-meta' => [
                    'title' => esc_html__('Custom Field Filter', 'king-addons'),
                    'description' => esc_html__('Filter products by SKU, ACF, or any custom field (text, select, or range). Pro.', 'king-addons'),
            ...
            'features' => [
                'faceted-filters' => [
                    'title' => esc_html__('Shop Filters', 'king-addons'),
                    'description' => esc_html__('Color, price, size, and more — filter products without reloading the page.', 'king-addons'),
